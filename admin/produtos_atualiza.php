...
if($_POST){     // O usuário clicou no botão atualizar
    if($_FILES['imagemfile']['name']){   // Se o usuário escolheu uma imagem
        // deletar a imagem atual da pasta (está decisão, poderá ser adiada para executar após a confirmação da alteração)
        unlink("..images/produtos_geral/".$_POST['imagem_atual']);  // Apaga a imagem
        $nome_img = $_FILES['imagemfile']['name'];
        $tmp_img = $_FILES['imagemfile']['tmp_name'];
        $rand = rand(100001,999999);
        $dir_img = "../images/produtos_geral/".$rand.$nome_img;
...
// Selecionar a lista de tipos para preecher o <select>
                ...
                <div class="card-body">
                    <form action="produtos_atualiza.php" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <textarea name="resumo" id="resumo" rows="5"
                                    class="form-control"><?=$prod['resumo']?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <img src="../images/produtos_geral/<?=$prod['imagem']?>"
